...
class display_card extends StatelessWidget {
  static const String routname='display_card';
  @override
  Widget build(BuildContext context) {
    displays_card result =ModalRoute.of(context)?.settings.arguments as displays_card;
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot<product>>(
          stream: gettaskFirebaseFirestorebycards(result.maincat,result.cards),
